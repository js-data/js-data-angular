describe('DS.createInstance(resourceName[, attrs][, options])', function () {
  ...
  it('should throw an error when method pre-conditions are not met', function () {
    ...
    }, DS.errors.NonexistentResourceError, errorPrefix + 'fruit loops is not a registered resource!');
    ...
    angular.forEach(TYPES_EXCEPT_OBJECT, function (key) {
      ...
      }, DS.errors.IllegalArgumentError, errorPrefix + 'attrs: Must be an object!');
    });
